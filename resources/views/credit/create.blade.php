    ...
    <table class="table">
      <thead class="thead-dark">
        <tr>
          ...
          <th class="text-right">Today is: {{$today}}</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td class="text-right"> {{ $debtors->count()}}</td>
        </tr>
        <tr>
          ...
          <td class="text-right">{{ $debtors->sum('perDayPay')}}.00 pesos</td>
        </tr>
        <tr>
          ...
          <td class="text-right">{{$debtors->sum('loanAmount')}}.00 pesos</td>
        </tr>
        <tr>
          ...
          <td class="text-right">{{$debtors->sum('totalPayable')}}.00 pesos</td>
        </tr>
      </tbody>
    </table>
    <table class="table">
